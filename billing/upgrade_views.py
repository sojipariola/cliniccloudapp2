...
def upgrade_plan(request, plan):
    ...
    try:
        ...
        session = stripe.checkout.Session.create(
            ...
            mode='subscription',
            success_url=request.build_absolute_uri('/billing/upgrade-success/?session_id={CHECKOUT_SESSION_ID}'),
    ...
    try:
        ...
        with transaction.atomic():
            ...
            if plan in PLAN_DETAILS:
                ...
                messages.success(request, f"Congratulations! You've upgraded to {PLAN_DETAILS[plan]['name']}.")
