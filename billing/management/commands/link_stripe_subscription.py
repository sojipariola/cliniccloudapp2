...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('stripe_customer_id', type=str, help='Stripe customer ID (cus_...)')
        parser.add_argument('stripe_subscription_id', type=str, help='Stripe subscription ID (sub_...)')
        parser.add_argument('plan', type=str, choices=list(PLAN_DETAILS.keys()), help='Plan name')
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            tenant.save(update_fields=['stripe_customer_id', 'stripe_subscription_id', 'plan', 'trial_ended_at'])
